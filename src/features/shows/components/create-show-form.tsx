...
import { useCreateShows } from "../api/use-create-show";
...
const currencyParser = (value: string) => {
  return Number(value.replace(/\D/g, "")) / 100; // Remove tudo que não for número e divide por 100
};

export const CreateShowsForm = ({
  onCancel,
  contratanteOptions,
  equipeOptions,
  locaisOptions,
